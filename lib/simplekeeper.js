...
function Server() {
    ...
    this.listen = function (port, host) {
        remote = simpleremote.createRemoteServer(this, ['getValue', 'setValue', 'exists', 'getChildren', 'delete']);
        remote.listen(port, host);
    }
...
exports.createClient = function (port, host, fn) {
